...
import { NgxtableService } from './ngxtable.service';
import { ResponsePage, ResponsePageEx, RequestPage, PageConfig } from '../../../system/result/page';
import { Student, Columns, TemplateData, wb_tmp_name, ws_tmp_name, StudentInterface, wb_export_name, ws_export_name } from './ngxtable';
import { Result } from '../../../system/result/result';
import { NgxDataTableMessage, Filter } from '../../../system/table/ngx-dataTable';
...
export class NgxtableComponent implements OnInit {
    ...
    constructor(private studentService: NgxtableService,
